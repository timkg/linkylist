	...
	exports.test_findsEmbedModelViaLinkProperty = function(test) {
		LinkModel
			...
			.exec(function(err, link) {
				if( err ) { throw err; }
				test.equals(link._embedlyOembed.provider_url, 'http://www.aplitrak.com', 'link finds embedly via embedlyId reference');
				test.done();
			});
	};
