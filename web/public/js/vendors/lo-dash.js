...
;(function(window) {
	 ...
	 * http://people.mozilla.org/~jorendorff/es6-draft.views#sec-7.8.6
	 */
	var reEsTemplate = /\$\{([^\\}]*(?:\\.[^\\}]*)*)\}/g;
     ...
     * });
		 ...
		 * See http://www.w3.org/TR/html5/infrastructure.views#internal-structured-cloning-algorithm.
		 *
		 * @static
		 * @memberOf _
		 * @category Objects
     ...
     * };
		 ...
		 * http://developer.chrome.com/stable/extensions/sandboxingEval.views
		 *
		 * @static
		 * @memberOf _
		 * @category Utilities
